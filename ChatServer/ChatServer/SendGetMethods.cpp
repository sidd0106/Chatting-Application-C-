...
void Server::SendStringRR(int ID, std::string & _string)
{
	PS::ReplyRegister message(_string);
	connections[ID]->pm.Append(message.toPacket());
}

void Server::SendStringRL(int ID, std::string & _string)
{
	PS::ReplyLogin message(_string);
	connections[ID]->pm.Append(message.toPacket());
}

void Server::SendStringRU(int ID, std::string & _string)
{
	PS::ReplyUserRequest message(_string);
	connections[ID]->pm.Append(message.toPacket());
}
